import 'package:dermo/features/pages/appointments/appointment_page.dart' as ap1;
import 'package:dermo/features/pages/appointments/appointments.dart';
          ...
          Row(
            children: [
              Expanded(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    var future = new FutureAppointment(doctorName: doctorName, doctorProfession: doctorProfession, reason: 'Monthly check-up', date: date, duration: _hourSelected!, clinicLocation: clinicLocation, imageUrl: imageUrl);
                    Navigator.push(
                      context,
                      MaterialPageRoute(
